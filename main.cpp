...
// Aquí se utilizarn datos de prueba..
// Se ingresan datos de prueba en tiempo de compilación.
...
int main() {
	// Se debe seguir una ruta lógica en la implementación de la aplicación.
	...
	// Segundo: Es crear objetos tipo Ruta, e Incluir una hora de salida en los objetos tipo Ruta..
	...
	Contenedora* CO = new Contenedora(10);
	...
	delete CO; // Aquí destruímos a la Contenedora
